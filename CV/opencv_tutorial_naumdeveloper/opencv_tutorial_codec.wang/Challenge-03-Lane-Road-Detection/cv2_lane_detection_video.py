...
def clean_lines(lines, threshold):
    # Итеративно вычисляем средний наклон, исключая данные с большой разницей из разности
    slope = [(y2 - y1) / (x2 - x1)
...
def least_squares_fit(point_list, ymin, ymax):
    ...
    # polyfit Третий параметр — это порядок полинома подгонки, поэтому 1 означает линейный
